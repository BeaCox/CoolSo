...
class SearchServer:
    ...
    def serve(self):
        ...
        def _gradio_search_ocr(query_text, topn, minimum_width, minimum_height, extension_choice):
            search_options = {
                "minimum_width": minimum_width,
                "minimum_height": minimum_height,
                "extension_choice": extension_choice,
            ...
            filename_list, score_list = server.search_ocr_text(query_text, topn=int(topn), search_filter_options=search_options)
            return server.convert_result_to_gradio(filename_list, score_list)
        ...
        with gr.Blocks() as demo:
            ...
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    ocr_textbox = gr.Textbox(lines=2, label="OCR Text")
                    button_ocr = gr.Button("Search OCR")
            ...
            button_ocr.click(_gradio_search_ocr, inputs=[ocr_textbox, topn, minimum_width, minimun_height, extension_choice], outputs=[gallery])
